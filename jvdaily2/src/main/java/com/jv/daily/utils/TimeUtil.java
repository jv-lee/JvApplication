...
import static com.jv.daily.utils.ConstUtil.MIN;
import static com.jv.daily.utils.ConstUtil.MSEC;
import static com.jv.daily.utils.ConstUtil.SEC;
import static com.jv.daily.utils.ConstUtil.TimeUnit;
...
public class TimeUtil {
     ...
     * @return
     */
    public static String milliseconds2StringSimple(long milliseconds) {
        return new SimpleDateFormat("yyyyMMdd").format(new Date(milliseconds));
    }
     ...
     * @return
     */
    public static long string2MillisecondsSimple(String time) {
        try {
    ...
    public static String getChineseTimeString(String time) {
        ...
        if (timeLong2 < ConstUtil.MIN) {
            return "刚刚";
        } else if (timeLong2 <= ConstUtil.HOUR) {
            return timeLong2 / ConstUtil.MIN + " 分钟";
        } else if (time.substring(0, 10).equals(getCurTimeString().substring(0, 10))) {
            return time.substring(11, 16);
        } else if (timeLong2 <= (ConstUtil.DAY * 2)) {
            return "昨天  " + time.substring(11, 16);
        } else if (timeLong2 <= (ConstUtil.DAY * 7)) {
    ...
    public static boolean isShowTime(String time) {
        ...
        if (timeList.size() == 0) {
            ...
            if ((timeLong2 - timeLong1) <= (ConstUtil.MIN * 20)) {
                timeList.add(time);
                return false;

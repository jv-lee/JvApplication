...
public class SettingsAlertAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class SettingsAlertViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onLayoutClick(View view) {
            ...
            if (Telephony.Sms.getDefaultSmsPackage(JvApplication.getInstance()).equals(bean.getPackageName())) {
                alertListener.dismissAlert();
            } else {
                SmsUtils.setDefaultSmsApplicationStartSettings(context, 0x0025, bean.getPackageName());
                alertListener.dismissAlert();
            }
        }

...
import static com.jv.sms.utils.ConstUtils.DAY;
import static com.jv.sms.utils.ConstUtils.HOUR;
import static com.jv.sms.utils.ConstUtils.MIN;
import static com.jv.sms.utils.ConstUtils.MSEC;
import static com.jv.sms.utils.ConstUtils.SEC;
import static com.jv.sms.utils.ConstUtils.TimeUnit;
...
public class TimeUtils {
    ...
    public static String getChineseTimeString(String time) {
        ...
        if (timeLong2 < ConstUtils.MIN) {
            return "刚刚";
        } else if (timeLong2 <= ConstUtils.HOUR) {
            return timeLong2 / ConstUtils.MIN + " 分钟";
        } else if (time.substring(0, 10).equals(getCurTimeString().substring(0, 10))) {
            return time.substring(11, 16);
        } else if (timeLong2 <= (ConstUtils.DAY * 2)) {
            return "昨天  " + time.substring(11, 16);
        } else if (timeLong2 <= (ConstUtils.DAY * 7)) {

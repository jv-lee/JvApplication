...
import com.jv.sms.utils.ColorStateListUtil;
...
public class SettingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class SettingsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindItemData(int position) {
            ...
            if (position == 0) {
                defaultFlag = SmsUtil.hasDefaultsSmsApplication(context);
            }
            ...
            if (setting.isSwitch()) {
                ...
                if (position == 1) {
                    if (defaultFlag) {
                        scOp.setTrackTintList(ColorStateListUtil.getSwitchTrackColorStateList(context,R.color.switch_true_track, R.color.switch_false_track));
                        scOp.setThumbTintList(ColorStateListUtil.getSwitchTrackColorStateList(context,R.color.switch_true_thumb, R.color.switch_false_thumb));
                    } else {
                        scOp.setTrackTintList(ColorStateListUtil.getSwitchTrackColorStateList(context,R.color.switch_track_dark, R.color.switch_track_dark));
                        scOp.setThumbTintList(ColorStateListUtil.getSwitchTrackColorStateList(context,R.color.switch_thumb_dark, R.color.switch_thumb_dark));
                    }
                }
